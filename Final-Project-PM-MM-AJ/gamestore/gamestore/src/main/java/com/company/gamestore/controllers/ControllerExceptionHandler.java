...
public class ControllerExceptionHandler {
    ...
    // This method handles IllegalArgument Exceptions
    @ExceptionHandler(value = IllegalArgumentException.class)
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY) // will return 422 error code
    ...
    // This method handles when Method Arguments are not valid such as JSR 303 validation failure
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND) // will return 404 error code
